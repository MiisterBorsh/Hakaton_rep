...
image = pygame.transform.scale(pygame.image.load('src/Textures/inventory.png'), (width, height))
rect = image.get_rect()

toolbar_image = pygame.transform.scale(pygame.image.load('src/Textures/toolbar.png'), (config.TILE_WIDTH * 3, config.TILE_WIDTH))
selector_image = pygame.transform.scale(pygame.image.load('src/Textures/selector.png'), (config.TILE_WIDTH, config.TILE_WIDTH))
...
pygame.font.init()
inventory_font = pygame.font.Font('src/Textures/Fonts/8bitOperatorPlus8-Regular.ttf', 24)
