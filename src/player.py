import pygame
from . import config, map, tiles, items, animations, sprites, inventory
import pygame
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, width, height, screen):
        ...
        self.image = pygame.transform.scale(pygame.image.load('src/Textures/player_states/front_0.png'), (self.width, self.height))
        self.rect = self.image.get_rect()

        down_0 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/front_0.png'), (self.width, self.height))
        down_1 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/front_1.png'), (self.width, self.height))
        up_0 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/back_0.png'), (self.width, self.height))
        up_1 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/back_1.png'), (self.width, self.height))
        right_0 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/right_0.png'), (self.width, self.height))
        right_1 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/right_1.png'), (self.width, self.height))
        left_0 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/left_0.png'), (self.width, self.height))
        left_1 = pygame.transform.scale(pygame.image.load('src/Textures/player_states/left_1.png'), (self.width, self.height))
        shovel_right_0 = pygame.transform.scale(pygame.image.load('src/Textures/shovel_animation/shovel_0.png'), (self.width * 2, self.height))
        shovel_right_1 = pygame.transform.scale(pygame.image.load('src/Textures/shovel_animation/shovel_1.png'), (self.width * 2, self.height))
        ...
        self.outline = pygame.transform.scale(pygame.image.load('src/Textures/outline.png'), (config.TILE_WIDTH, config.TILE_WIDTH))
